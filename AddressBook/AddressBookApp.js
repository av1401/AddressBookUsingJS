...
class AddressBookApp {
    ...
    validateContact(firstName, lastName, address, city, state, zip, phone, email) {
        ...
        const stateRegex = /^[A-Za-z\s]{4,}$/; // FIXED: State should contain only letters
        ...
        if (!stateRegex.test(state)) throw new Error("Invalid State"); // FIXED
    ...
    addContact(bookName, firstName, lastName, address, city, state, zip, phone, email) {
        ...
        try {
            ...
            // FIXED: Checking duplicates before adding
            const isDuplicate = this.addressBooks[bookName].some(
                c => c.firstName === firstName && c.lastName === lastName
            );
            if (isDuplicate) {
                console.log(`Duplicate entry! Contact '${firstName} ${lastName}' already exists in '${bookName}'.`);
                return;
            }
    ...
    countContacts(bookName) {
        ...
        // FIXED: Use .length instead of reduce function
        const contactCount = this.addressBooks[bookName].length;
...
app.addContact("Personal", "John", "Doe", "123 Main St", "New York", "New York", "10001", "9876543210", "john.doe@example.com");
...
app.addContact("Personal", "John", "Doe", "123 Main St", "New York", "California", "10001", "9876543210", "john.doe@example.com");
app.addContact("Work", "Vinay", "Jadaun", "456 Market St", "New Jersey", "New Jersey", "90001", "9123456789", "vinay.jadaun@example.com");
